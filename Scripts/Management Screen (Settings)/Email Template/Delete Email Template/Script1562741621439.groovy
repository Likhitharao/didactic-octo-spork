...
WebUI.click(findTestObject('Management Screen (Settings)/Email Template Settings/Delete Email template button'))

WebUI.click(findTestObject('Management Screen (Settings)/Email Template Settings/Delete Yes'))
