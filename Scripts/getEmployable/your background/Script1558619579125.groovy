...
WebUI.comment('Enter yourbackground details')

Random rad = new Random()

ethnicity = WebUI.getNumberOfTotalOption(findTestObject('getEmployable/Employee details/21-05-2019/background/ehnicity'))

ethnicitycount = (1 + rad.nextInt(ethnicity - 1))

'Select Ethnicity'
WebUI.selectOptionByIndex(findTestObject('getEmployable/Employee details/21-05-2019/background/ehnicity'), ethnicitycount)
...
'Click interested/not interested'
WebUI.click(findTestObject('getEmployable/Employee details/21-05-2019/background/Page_getEmployable - Assessment Form/interested'))

WebUI.delay(5)

'Click met/not met with criteria'
WebUI.click(findTestObject('getEmployable/Employee details/21-05-2019/background/met'))

'Privacy policy'
WebUI.click(findTestObject('getEmployable/Employee details/21-05-2019/background/Tick1'))
