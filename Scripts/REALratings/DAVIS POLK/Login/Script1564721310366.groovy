...
WebUI.comment('DAVIS POLK- Login')

'Open Browser'
WebUI.openBrowser('')

'Login to DAVIS POLK Application'
WebUI.navigateToUrl('https://davispolk-uat.realrating.co.uk/login')
...
assert WebUI.getUrl() == 'https://davispolk-uat.realrating.co.uk/login'
