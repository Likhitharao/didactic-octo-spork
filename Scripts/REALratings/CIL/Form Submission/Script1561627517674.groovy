...
WebUI.comment('CIL REAlrating - Form Submission')

'Open Browser'
WebUI.openBrowser('')

'Launch CIL Application'
WebUI.navigateToUrl('https://uat-cil.realrating.co.uk/')
...
assert WebUI.getUrl() == 'https://uat-cil.realrating.co.uk/thankyou'
