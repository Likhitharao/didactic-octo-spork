...
WebUI.comment('CIL- Login')

'Open Browser'
WebUI.openBrowser('')

'Login to CIL Application'
WebUI.navigateToUrl('https://uat-cil.realrating.co.uk/login')
...
assert WebUI.getUrl() == 'https://uat-cil.realrating.co.uk/login'
