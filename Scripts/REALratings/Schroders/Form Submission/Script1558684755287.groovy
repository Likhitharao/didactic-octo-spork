...
WebUI.comment('Schroders - Form Submission')

'Open Browser'
WebUI.openBrowser('')

'Launch Greensill Application'
WebUI.navigateToUrl('https://schroders-uat.realrating.co.uk/')
...
WebUI.setText(findTestObject('REALRatings/Greensill/Page_REALrating/University Emailid'), ('greensill' + Email) + '@test.com')
...
WebUI.click(findTestObject('REALRatings/Schroders/second next'))
...
'A-Level year'
ALevelYearTotalOptions = WebUI.getNumberOfTotalOption(findTestObject('REALRatings/Schroders/Alevelyear'))

ALevelYearcount = (1 + rad.nextInt(ALevelYearTotalOptions - 1))

WebUI.selectOptionByIndex(findTestObject('REALRatings/Schroders/Alevelyear'), ALevelYearcount)

'GCSE Year'
GCSEYearTotalOptions = WebUI.getNumberOfTotalOption(findTestObject('REALRatings/Schroders/Gcse year'))

GCSEYearCount = (1 + rad.nextInt(GCSEYearTotalOptions - 1))

WebUI.selectOptionByIndex(findTestObject('REALRatings/Schroders/Gcse year'), GCSEYearCount)
...
assert WebUI.getUrl() == 'https://schroders-uat.realrating.co.uk/thankyou'
