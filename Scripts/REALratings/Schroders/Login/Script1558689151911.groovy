...
WebUI.comment('Schroders - Login')

'Open Browser'
WebUI.openBrowser('')

'Login to 2020Delivery Application'
WebUI.navigateToUrl('https://schroders-uat.realrating.co.uk/login')
...
assert WebUI.getUrl() == 'https://schroders-uat.realrating.co.uk/login'
