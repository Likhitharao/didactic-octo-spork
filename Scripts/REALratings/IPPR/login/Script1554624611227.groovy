...
WebUI.comment('IPPR - Login')

'Open Browser'
WebUI.openBrowser('')

'Login to IPPI Application'
WebUI.navigateToUrl('https://ippr-uat.realrating.co.uk/login')
...
assert WebUI.getUrl() == 'https://ippr-uat.realrating.co.uk/login'
