...
WebUI.comment('Hymans Robertson- Form Submission')

'Open Browser'
WebUI.openBrowser('')

'Launch Hymans Robertson Application'
WebUI.navigateToUrl('https://uat-hr.realrating.co.uk/')
...
WebUI.setText(findTestObject('REALRatings/NorthHighland/Page_REALrating/University Emailid'), ('hr' + Email) + '@test.com')
...
assert WebUI.getUrl() == 'https://uat-hr.realrating.co.uk/thankyou'
