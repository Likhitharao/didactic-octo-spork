...
WebUI.comment('Hymans Robertson- Login')

'Open Browser'
WebUI.openBrowser('')

'Login to Hymans Robertson Application'
WebUI.navigateToUrl('https://uat-hr.realrating.co.uk/login')
...
'Logout of Hymans Robertson Application'
...
assert WebUI.getUrl() == 'https://uat-hr.realrating.co.uk/login'
